...
public class SearchStepDefinitions {
    ...
    public void userTypeInSearchLine(String searchInput) {
        searchScreen.sendKeysToSearchField(searchInput);
    }

    @When("search result is displayed")
    public void searchResultIsDisplayed() {
        searchScreen.searchResultIsDisplayed();
    }

    @When("click on search result for word Appium")
    public void clickOnSearchAppiumResult() {
        searchScreen.clickOnAppiumResultOfSearch();
    }
}
